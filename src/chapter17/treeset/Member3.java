...
//public class Member3 implements Comparable<Member3> { //compareto (오버라이딩)
	 ...
	 * 방법1
	 * 
	 * @Override public boolean equals(Object obj) { if (obj instanceof Member2) {
	...
	public boolean equals(Object obj) {
		if (obj instanceof Member3) {
			...
			if (this.memberId == member.memberId) { // return member.memberName.equals(memberName) && (member.memberId
													// == memberId);
				return true;
			}
		}
