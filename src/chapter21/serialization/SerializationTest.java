...
public class SerializationTest {
	...
	public static void main(String[] args) {
		...
		/*
		 * ObjectOutputStream : 파일이나 네트워크로 데이터를 전달하기 위해서 직렬화를 수행해줌 (즉 직렬화)
		 * writeObject() : 직렬화 메소드
		 */
		// ====================================직렬화======================================
		...
		// ==================================역직렬화======================================
		/*
		 * ObjectOutputStream : 파일이나 네트워크를 통해 전달받은 직렬화된 데이터를 다시 원래대로 돌리는 역할 (즉 역직렬화)
		 * readObject() : 역직렬화에 사용되는 메소드 직렬화 하기전 객체로 캐스팅해줘야 함
		 */
